...
const Credentials: React.FC<CredentialsProps> = ({ isLightMode }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className={`border-l-4 p-5 rounded-r transition-all shadow-sm ${
              isLightMode 
                ? `bg-white border-emerald-500 border-y border-r border-slate-100` 
              ...
              <p className="mono text-xs text-gray-500">Lovely Professional University – INDIA</p>
            </div>
